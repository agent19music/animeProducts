    ...
    fetch('http://localhost:3000/animes/' + animeId)
      ...
      .then((res) => {
        ...
        updateForm.addEventListener('submit', function (e) {
          ...
          // Send a PUT request to update the anime
          fetch('http://localhost:3000/animes/' + animeId, {
            method: 'PATCH',
            headers: {
...
document.getElementById('newAnime').addEventListener('click', function (e) {
  ...
  document.getElementById('anime-details-form').addEventListener('submit', function (e) {
      ...
      // Handle the data (you can send it to your server or add it to your data store)
...
function addAnime(animeDetails) {
  // Send a PUT request to add the new anime on the backend
  ...
  .then((newAnime) => {
      // You can handle the new anime data here (e.g., update the UI)
